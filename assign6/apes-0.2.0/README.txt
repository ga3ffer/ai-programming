...
% This code is modified for assignment 6 problem 2
% Modified files include:
%
%     main.pl - added lines to load the group files created
%     knowledge.pl - dynamically appended built up knowledge from command line
%     group.pl - dynamically appednded hawaiian fish group from command line
%
%
